...
class AwsSpringHttpProcessingUtils {
	...
	private static HttpServletRequest generateRequest2(String request, Context lambdaContext,
		...
		ServerlessHttpServletRequest httpRequest = new CustomServerlessHttpServletRequest(servletContext,
		...
		httpRequest.setPathInfo(v2Request.getRequestContext().getHttp().getPath());
